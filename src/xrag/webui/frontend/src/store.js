...
export const store = reactive({
  step: 1, options: null, capabilities: null, config: null, error: '', notice: '', loading: false,
  dataset: null, presetDataset: 'hotpot_qa', uploadFile: null,
  ...
  selectedMetrics: [], numSamples: 5, experiment1: false,
